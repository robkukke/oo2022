...
public class Meeskond {
    ...
    String nimetus;
    public Meeskond(String uusNimetus) {
        nimetus = uusNimetus;
    }
    public void lisaMangija(Mangija m) {
        mangijad.add(m);
    }
...
// Looge prooviprogramm meeskonna ja kahe mängijaga, selles kuvage mängijate andmed praegu ja kahe sekundi pärast